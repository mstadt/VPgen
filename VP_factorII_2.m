...
% hyperparameters
delta_lev = 0.175; %0.20; %0.25; %0.05; % hyperparameter for added noise on percentiles
delta_dsg = 0.1; %0.11; %0.1; %0.09; %0.12; %0.15; % hyperparamger

MEAN_err = 0.115; %0.1; % percentage error from given mean
STD_err  = 0.1; % percentage error from given STD

% Maximum number of trials
MAX_TRIALS = 1e3; %100; %5e3; %100; %500; %5e3; %100;
